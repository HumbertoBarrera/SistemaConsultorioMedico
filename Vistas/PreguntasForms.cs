...
namespace SistemaConsultorioMedico
{
    public partial class Preguntas : Form
    {
        ...
        {
            if (dato10Rbtn1.Checked == true && dato01Rbtn2.Checked == false && dato10Rbtn3.Checked == false && dato10Rbtn4.Checked == false && (dato10Tbx.Text == "OTRO" | dato10Tbx.Text == ""))
            {
                return dato10Rbtn1.Text;
            }
            else if (dato10Rbtn1.Checked == false && dato01Rbtn2.Checked == true && dato10Rbtn3.Checked == false && dato10Rbtn4.Checked == false && (dato10Tbx.Text == "OTRO" | dato10Tbx.Text == ""))
            {
                return dato01Rbtn2.Text;
            }
            else if (dato10Rbtn1.Checked == false && dato01Rbtn2.Checked == false && dato10Rbtn3.Checked == true && dato10Rbtn4.Checked == false && (dato10Tbx.Text == "OTRO" | dato10Tbx.Text == ""))
            {
                return dato10Rbtn3.Text;
            }
            else if (dato10Rbtn1.Checked == false && dato01Rbtn2.Checked == false && dato10Rbtn3.Checked == false && dato10Rbtn4.Checked == true && (dato10Tbx.Text == "OTRO" | dato10Tbx.Text == ""))
            {
